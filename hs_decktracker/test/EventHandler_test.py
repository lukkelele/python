...
eventDetails_test2 = '[entityName=Lightbomb id=23 zone=HAND zonePos=2 cardId=CORE_GVG_008 player=1]'
...
def test_gettingEventDetails():
    ...
    assert "CORE_GVG_008" == eventHandler.getEventDetails(eventDetails_test2)
