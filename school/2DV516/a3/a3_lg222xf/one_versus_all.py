...
class OneVersusAll:
    ...
    def __init__(self, tune_params=False, test_size=0.10, train_size=0.30, verbose=True):
        print("\n==> Executing script...")
        if train_size < 0.10:
            print("==> PLEASE NOTE: Smaller training and test sets results in faster but worse results.\n"+
                  "    Running 20/80 results in an accuracy over 95%!")
...
one = OneVersusAll(test_size=0.04, train_size=0.08)
